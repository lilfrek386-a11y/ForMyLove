...
function popBall(id) {
    ...
    const messages = {
        1: "Ты даришь мне радость каждый день. Я хочу быть с тобой, ты прекрасна.",
        2: "Я ценю каждую секунду, проведенную вместе. Прости если обижал, мне очень стыдно за это",
        3: "Будущее с тобой - моя самая большая мечта. Я верю что у нас все будет хорошо",
    };
